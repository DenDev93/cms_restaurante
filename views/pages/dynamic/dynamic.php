    ...
    <div class="row">
        ...
        <?php if (!empty($modules)): ?>
            ...
            <?php
                ...
                /*=============================================
                Si la página ya muestra el grid personalizado de mesas,
                se omite la tabla genérica de mesas para no duplicarla
                =============================================*/

                $tieneGridMesas = false;

                foreach ($modules as $m) {

                    if ($m->type_module == "custom" && $m->title_module == "mesas") {
            ...
            <?php foreach ($modules as $key => $value): $module = $value ?>
                ...
                <?php if ($module->type_module == "tables" && $tieneGridMesas): continue; endif ?>
