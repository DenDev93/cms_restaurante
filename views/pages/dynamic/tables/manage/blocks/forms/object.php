...
<input 
							...
							id="propertyObject_<?php echo $key ?>"
							onchange="changeItemObject('<?php echo $module->columns[$i]->title_column ?>')"
							value="<?php echo $key ?>"
							>

							<label for="propertyObject_<?php echo $key ?>">Propiedad</label>
...
<input 
							...
							id="valueObject_<?php echo $key ?>"
							onchange="changeItemObject('<?php echo $module->columns[$i]->title_column ?>')"
							value="<?php echo htmlspecialchars($value) ?>"
							>

							<label for="valueObject_<?php echo $key ?>">Valor</label>
				...
				<div class="row row-cols-1 row-cols-sm-2 itemObject">
					...
					<div class="col">
						...
						<div class="form-floating mb-3">
							...
							<label for="propertyObject_0">Propiedad</label>
					...
					<div class="col">
						...
						<div class="form-floating mb-3">
							...
							<label for="valueObject_0">Valor</label>
