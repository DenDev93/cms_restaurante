        ...
        <div class="modal-body px-4">
          ...
          <div id="metricsBlock" class="row row-cols-1 row-cols-md-3 row-cols-lg-6" style="display:none">
            ...
            <div class="col mb-3">
              ...
              <label for="metricTable">Tabla</label>
            ...
            <div class="col mb-3">
              ...
              <label for="metricColumn">Columna</label>
            ...
            <div class="col mb-3">
              ...
              <label for="metricConfig">Config</label>
            ...
            <div class="col mb-3">
              ...
              <label for="metricIcon">Icono</label>
          ...
          <div id="graphicsBlock" class="row row-cols-1 row-cols-md-3 row-cols-lg-5" style="display:none">
            ...
            <div class="col mb-3">
              ...
              <label for="graphicType">Tipo</label>
            ...
            <div class="col mb-3">
              ...
              <label for="graphicTable">Tabla</label>
              <input 
              type="text" 
            ...
            <div class="col mb-3">
              ...
              <label for="graphicX">Eje X</label>
              <input 
              type="text" 
              class="form-control rounded form-control-sm changeGraphic" 
              id="graphicX">
            ...
            <div class="col mb-3">
              ...
              <label for="graphicY">Eje Y</label>
              <input 
              type="text" 
              class="form-control rounded form-control-sm changeGraphic" 
              id="graphicY">
            ...
            <div class="col mb-3">
              ...
              <label for="graphicColor">Color</label>
